...
## Project Structure
    ...
    ├── testapiautosetting_127310  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127310`
...
2. Clone this repo and `cd testapiautosetting_127310`
